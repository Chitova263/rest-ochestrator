...
import {Task, TaskSchema} from "../index";
...
export function buildAdjacencyList(dependencyConfiguration: TaskConfiguration<Task>, adjacencyListRepresentation: Map<Task, Task[]>):  Map<Task, Task[]> {
