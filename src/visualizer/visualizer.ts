...
export function buildDependencyGraph(pathToFile: string, configuration: Task<Tasks> | null): Task<Tasks> | null {
...
export function buildAdjacencyList(
    dependencyConfiguration: Task<Tasks>,
    adjacencyListRepresentation: Map<Tasks, Tasks[]>
): Map<Tasks, Tasks[]> {
    const task: Tasks = dependencyConfiguration.name;
    const dependsOn: Tasks[] = dependencyConfiguration.dependsOn;
